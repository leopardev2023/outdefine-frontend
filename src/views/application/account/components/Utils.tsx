...
export const checkWeek = (checkDate: string) => {
  ...
  if (
    diff_minutes(new Date(checkDate), firstDay) >= 0 &&
    diff_minutes(new Date(checkDate), firstDay) <= 6
  ) {
    return true;
  } else {
    return false;
...
export const checkMonth = (checkDate) => {
  ...
  if (
    diff_minutes(new Date(checkDate), firstDay) >= 0 &&
    diff_minutes(new Date(checkDate), firstDay) < 31
  ) {
    return true;
  } else {
    return false;
...
export const checkYear = (checkDate) => {
  ...
  if (
    diff_minutes(new Date(checkDate), firstDay) >= 0 &&
    diff_minutes(new Date(checkDate), firstDay) < 365
  ) {
    return true;
  } else {
    return false;
...
export const checkLastYear = (checkDate) => {
  ...
  if (
    diff_minutes(new Date(checkDate), firstDay) >= 365 &&
    diff_minutes(new Date(checkDate), firstDay) < 365 * 2
  ) {
    return true;
  } else {
    return false;
...
export const checkSemi = (checkDate) => {
  ...
  if (
    diff_minutes(new Date(checkDate), firstDay) >= 0 &&
    diff_minutes(new Date(checkDate), lastDay) <= 0
  ) {
    return true;
  } else {
    return false;
