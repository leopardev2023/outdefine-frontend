...
const Hackerearth = (props: Props) => {
  const { assessmentTitle, confirmedType, hackerearthMcqStatus, hackerearthReviewed } =
    props.mainData;
  ...
  }, [hackerearthMcqStatus, setModalOpen]);
  ...
  return (
    <Assessment
      time={60}
      type={AssessmentType.hackerearth}
      {...UIData.hackerearth}
      stage={assessmentTitle}
