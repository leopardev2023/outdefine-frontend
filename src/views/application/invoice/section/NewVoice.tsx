...
const NewVoice = ({ setNextStepPage }: Props) => {
  ...
  return (
    <Wrapper
      ...
      ban_title='Invoice'
      ban_content='Update invoice detail'
      ban_img={Welcome}
    >
        ...
        <div className='flex justify-between relative'>
          <div className='flex gap-x-14'>
            <button
              ...
              onClick={() => {
                localStorage.setItem('viewCheck', 'true');
        ...
        <div className='mt-9 rounded-[15px] shadow-3xl border-white'>
          <div className='mx-[110px] flex justify-between mt-8 py-10'>
            ...
            <div className='flex flex-col justify-start pl-4 py-6 border-separate border-l-2 float-left font-semibold text-base h-[120px] gap-x-4'>
              <span>Invoice: </span>
              <span>Issue Date {invoice.date_issued}</span>
              <span>Due Date {invoice.date_due}</span>
            </div>
          </div>
