...
const UploadLogoModal = ({
  ...
  return (
    <>
      ...
      />
      <div className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[476px] h-[400px] bg-[#2F3454] rounded-[15px] p-[18px] shadow-2xl'>
        <button
        ...
        <h4 className='text-[24px] text-white font-semibold w-full text-center'>
          {title}
        </h4>
        ...
        {opened ? (
          <ul
            ...
            className='z-20 bg-white w-[282px] h-[116px] text-[14px] rounded-[10px] shadow-[0px_0px_10px_4px_#2E2E2E] mt-[10px] mx-auto flex flex-col justify-between'
          >
            <div
